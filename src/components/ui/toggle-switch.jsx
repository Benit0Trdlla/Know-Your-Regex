    ...
    return (
        <>
            <div className="relative bg-inherit rounded-full border-1 border-gray p-0.5 m-3 w-48">
                <div
                    className={`absolute top-0.5 bottom-0.5 w-1/2 bg-gray-500 rounded-full transition-transform duration-300 ease-in-out ${activeOption === "traducir" || activeOption === "translate" ? "translate-x-full" : "translate-x-0"}`}
                />
